 ...
 509                     ; 124     UART1->BRR2 |= (uint8_t)((uint8_t)(((BaudRate_Mantissa100 - (BaudRate_Mantissa * 100)) << 4) / 100) & (uint8_t)0x0F); 
 ...
 541                     ; 126     UART1->BRR2 |= (uint8_t)((BaudRate_Mantissa >> 4) & (uint8_t)0xF0); 
 ...
 594                     ; 151         UART1->CR2 |= (uint8_t)UART1_CR2_REN;  
 596  0138 72145235      	bset	21045,#2
 598  013c 2004          	jra	L102
 599  013e               L771:
 600                     ; 156         UART1->CR2 &= (uint8_t)(~UART1_CR2_REN);  
 602  013e 72155235      	bres	21045,#2
 603  0142               L102:
 604                     ; 160     if ((uint8_t)(SyncMode & UART1_SYNCMODE_CLOCK_DISABLE))
 606  0142 7b16          	ld	a,(OFST+10,sp)
 607  0144 a580          	bcp	a,#128
 608  0146 2706          	jreq	L302
 609                     ; 163         UART1->CR3 &= (uint8_t)(~UART1_CR3_CKEN); 
 611  0148 72175236      	bres	21046,#3
 613  014c 200a          	jra	L502
 614  014e               L302:
 615                     ; 167         UART1->CR3 |= (uint8_t)((uint8_t)SyncMode & UART1_CR3_CKEN);
 ...
 626  015a 81            	ret
 681                     ; 177 void UART1_Cmd(FunctionalState NewState)
 681                     ; 178 {
 682                     	switch	.text
 683  015b               _UART1_Cmd:
 687                     ; 179     if (NewState != DISABLE)
 689  015b 4d            	tnz	a
 690  015c 2706          	jreq	L532
 691                     ; 182         UART1->CR1 &= (uint8_t)(~UART1_CR1_UARTD); 
 693  015e 721b5234      	bres	21044,#5
 695  0162 2004          	jra	L732
 696  0164               L532:
 697                     ; 187         UART1->CR1 |= UART1_CR1_UARTD;  
 699  0164 721a5234      	bset	21044,#5
 700  0168               L732:
 701                     ; 189 }
 704  0168 81            	ret
 829                     ; 205 void UART1_ITConfig(UART1_IT_TypeDef UART1_IT, FunctionalState NewState)
 829                     ; 206 {
 830                     	switch	.text
 ...
 838                     ; 207     uint8_t uartreg = 0, itpos = 0x00;
 842                     ; 210     assert_param(IS_UART1_CONFIG_IT_OK(UART1_IT));
 844                     ; 211     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 846                     ; 214     uartreg = (uint8_t)((uint16_t)UART1_IT >> 0x08);
 848  016b 9e            	ld	a,xh
 ...
 931  01ce               L733:
 932                     ; 247             UART1->CR4 &= (uint8_t)(~itpos);
 ...
 943  01d9 81            	ret
 979                     ; 258 void UART1_HalfDuplexCmd(FunctionalState NewState)
 979                     ; 259 {
 980                     	switch	.text
 981  01da               _UART1_HalfDuplexCmd:
 985                     ; 260     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 987                     ; 262     if (NewState != DISABLE)
 989  01da 4d            	tnz	a
 990  01db 2706          	jreq	L163
 991                     ; 264         UART1->CR5 |= UART1_CR5_HDSEL;  /**< UART1 Half Duplex Enable  */
...
1001                     ; 270 }
1004  01e7 81            	ret
1061                     ; 278 void UART1_IrDAConfig(UART1_IrDAMode_TypeDef UART1_IrDAMode)
1061                     ; 279 {
1062                     	switch	.text
1063  01e8               _UART1_IrDAConfig:
1067                     ; 280     assert_param(IS_UART1_IRDAMODE_OK(UART1_IrDAMode));
1069                     ; 282     if (UART1_IrDAMode != UART1_IRDAMODE_NORMAL)
1071  01e8 4d            	tnz	a
1072  01e9 2706          	jreq	L314
1073                     ; 284         UART1->CR5 |= UART1_CR5_IRLP;
...
1083                     ; 290 }
1086  01f5 81            	ret
1121                     ; 298 void UART1_IrDACmd(FunctionalState NewState)
1121                     ; 299 {
1122                     	switch	.text
1123  01f6               _UART1_IrDACmd:
1127                     ; 302     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1129                     ; 304     if (NewState != DISABLE)
1131  01f6 4d            	tnz	a
1132  01f7 2706          	jreq	L534
1133                     ; 307         UART1->CR5 |= UART1_CR5_IREN;
...
1143                     ; 314 }
1146  0203 81            	ret
1205                     ; 323 void UART1_LINBreakDetectionConfig(UART1_LINBreakDetectionLength_TypeDef UART1_LINBreakDetectionLength)
1205                     ; 324 {
1206                     	switch	.text
1207  0204               _UART1_LINBreakDetectionConfig:
1211                     ; 325     assert_param(IS_UART1_LINBREAKDETECTIONLENGTH_OK(UART1_LINBreakDetectionLength));
1213                     ; 327     if (UART1_LINBreakDetectionLength != UART1_LINBREAKDETECTIONLENGTH_10BITS)
1215  0204 4d            	tnz	a
1216  0205 2706          	jreq	L764
1217                     ; 329         UART1->CR4 |= UART1_CR4_LBDL;
...
1227                     ; 335 }
1230  0211 81            	ret
1265                     ; 343 void UART1_LINCmd(FunctionalState NewState)
1265                     ; 344 {
1266                     	switch	.text
1267  0212               _UART1_LINCmd:
1271                     ; 345     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1273                     ; 347     if (NewState != DISABLE)
1275  0212 4d            	tnz	a
1276  0213 2706          	jreq	L115
1277                     ; 350         UART1->CR3 |= UART1_CR3_LINEN;
...
1287                     ; 357 }
1290  021f 81            	ret
1325                     ; 364 void UART1_SmartCardCmd(FunctionalState NewState)
1325                     ; 365 {
1326                     	switch	.text
1327  0220               _UART1_SmartCardCmd:
1331                     ; 366     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1333                     ; 368     if (NewState != DISABLE)
1335  0220 4d            	tnz	a
1336  0221 2706          	jreq	L335
1337                     ; 371         UART1->CR5 |= UART1_CR5_SCEN;
...
1347                     ; 378 }
1350  022d 81            	ret
1386                     ; 387 void UART1_SmartCardNACKCmd(FunctionalState NewState)
1386                     ; 388 {
1387                     	switch	.text
1388  022e               _UART1_SmartCardNACKCmd:
1392                     ; 389     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1394                     ; 391     if (NewState != DISABLE)
1396  022e 4d            	tnz	a
1397  022f 2706          	jreq	L555
1398                     ; 394         UART1->CR5 |= UART1_CR5_NACK;
...
1408                     ; 401 }
1411  023b 81            	ret
1468                     ; 409 void UART1_WakeUpConfig(UART1_WakeUp_TypeDef UART1_WakeUp)
1468                     ; 410 {
1469                     	switch	.text
1470  023c               _UART1_WakeUpConfig:
1474                     ; 411     assert_param(IS_UART1_WAKEUP_OK(UART1_WakeUp));
1476                     ; 413     UART1->CR1 &= ((uint8_t)~UART1_CR1_WAKE);
1478  023c 72175234      	bres	21044,#3
1479                     ; 414     UART1->CR1 |= (uint8_t)UART1_WakeUp;
1481  0240 ca5234        	or	a,21044
1482  0243 c75234        	ld	21044,a
1483                     ; 415 }
1486  0246 81            	ret
1522                     ; 422 void UART1_ReceiverWakeUpCmd(FunctionalState NewState)
1522                     ; 423 {
1523                     	switch	.text
1524  0247               _UART1_ReceiverWakeUpCmd:
1528                     ; 424     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1530                     ; 426     if (NewState != DISABLE)
1532  0247 4d            	tnz	a
1533  0248 2706          	jreq	L526
1534                     ; 429         UART1->CR2 |= UART1_CR2_RWU;
...
1544                     ; 436 }
1547  0254 81            	ret
1570                     ; 443 uint8_t UART1_ReceiveData8(void)
1570                     ; 444 {
1571                     	switch	.text
1572  0255               _UART1_ReceiveData8:
1576                     ; 445     return ((uint8_t)UART1->DR);
1578  0255 c65231        	ld	a,21041
1581  0258 81            	ret
1615                     ; 453 uint16_t UART1_ReceiveData9(void)
1615                     ; 454 {
1616                     	switch	.text
1617  0259               _UART1_ReceiveData9:
1619  0259 89            	pushw	x
1620       00000002      OFST:	set	2
1623                     ; 455   uint16_t temp = 0;
1625                     ; 457   temp = (uint16_t)(((uint16_t)( (uint16_t)UART1->CR1 & (uint16_t)UART1_CR1_R8)) << 1);
...
1635                     ; 458   return (uint16_t)( (((uint16_t) UART1->DR) | temp ) & ((uint16_t)0x01FF));
...
1653  027a 81            	ret
1687                     ; 466 void UART1_SendData8(uint8_t Data)
1687                     ; 467 {
1688                     	switch	.text
1689  027b               _UART1_SendData8:
1693                     ; 469     UART1->DR = Data;
1695  027b c75231        	ld	21041,a
1696                     ; 470 }
1699  027e 81            	ret
1733                     ; 478 void UART1_SendData9(uint16_t Data)
1733                     ; 479 {
1734                     	switch	.text
1735  027f               _UART1_SendData9:
1737  027f 89            	pushw	x
1738       00000000      OFST:	set	0
1741                     ; 481     UART1->CR1 &= ((uint8_t)~UART1_CR1_T8);
1743  0280 721d5234      	bres	21044,#6
1744                     ; 483     UART1->CR1 |= (uint8_t)(((uint8_t)(Data >> 2)) & UART1_CR1_T8);
1746  0284 54            	srlw	x
1747  0285 54            	srlw	x
...
1752                     ; 485     UART1->DR   = (uint8_t)(Data);
1754  028f 7b02          	ld	a,(OFST+2,sp)
1755  0291 c75231        	ld	21041,a
1756                     ; 486 }
1759  0294 85            	popw	x
1760  0295 81            	ret
1783                     ; 493 void UART1_SendBreak(void)
1783                     ; 494 {
1784                     	switch	.text
1785  0296               _UART1_SendBreak:
1789                     ; 495     UART1->CR2 |= UART1_CR2_SBK;
1791  0296 72105235      	bset	21045,#0
1792                     ; 496 }
1795  029a 81            	ret
1829                     ; 503 void UART1_SetAddress(uint8_t UART1_Address)
1829                     ; 504 {
1830                     	switch	.text
1831  029b               _UART1_SetAddress:
1833  029b 88            	push	a
1834       00000000      OFST:	set	0
1837                     ; 506     assert_param(IS_UART1_ADDRESS_OK(UART1_Address));
1839                     ; 509     UART1->CR4 &= ((uint8_t)~UART1_CR4_ADD);
1841  029c c65237        	ld	a,21047
1842  029f a4f0          	and	a,#240
1843  02a1 c75237        	ld	21047,a
1844                     ; 511     UART1->CR4 |= UART1_Address;
...
1852  02ac 84            	pop	a
1853  02ad 81            	ret
1887                     ; 520 void UART1_SetGuardTime(uint8_t UART1_GuardTime)
1887                     ; 521 {
1888                     	switch	.text
1889  02ae               _UART1_SetGuardTime:
1893                     ; 523     UART1->GTR = UART1_GuardTime;
1895  02ae c75239        	ld	21049,a
1896                     ; 524 }
1899  02b1 81            	ret
1933                     ; 548 void UART1_SetPrescaler(uint8_t UART1_Prescaler)
1933                     ; 549 {
1934                     	switch	.text
1935  02b2               _UART1_SetPrescaler:
1939                     ; 551     UART1->PSCR = UART1_Prescaler;
1941  02b2 c7523a        	ld	21050,a
1942                     ; 552 }
1945  02b5 81            	ret
2088                     ; 560 FlagStatus UART1_GetFlagStatus(UART1_Flag_TypeDef UART1_FLAG)
2088                     ; 561 {
2089                     	switch	.text
...
2097                     ; 562     FlagStatus status = RESET;
2099                     ; 565     assert_param(IS_UART1_FLAG_OK(UART1_FLAG));
2101                     ; 569     if (UART1_FLAG == UART1_FLAG_LBDF)
2103  02b8 a30210        	cpw	x,#528
2104  02bb 2610          	jrne	L7501
2105                     ; 571         if ((UART1->CR4 & (uint8_t)UART1_FLAG) != (uint8_t)0x00)
...
2141  02e1               L1701:
2142                     ; 592             status = RESET;
2144  02e1 0f01          	clr	(OFST+0,sp)
2146  02e3 200f          	jra	L5601
2147  02e5               L7601:
2148                     ; 597         if ((UART1->SR & (uint8_t)UART1_FLAG) != (uint8_t)0x00)
...
2165  02f4               L5601:
2166                     ; 609     return status;
2168  02f4 7b01          	ld	a,(OFST+0,sp)
2171  02f6 5b03          	addw	sp,#3
2172  02f8 81            	ret
2207                     ; 639 void UART1_ClearFlag(UART1_Flag_TypeDef UART1_FLAG)
2207                     ; 640 {
2208                     	switch	.text
2209  02f9               _UART1_ClearFlag:
2213                     ; 641     assert_param(IS_UART1_CLEAR_FLAG_OK(UART1_FLAG));
2215                     ; 644     if (UART1_FLAG == UART1_FLAG_RXNE)
2217  02f9 a30020        	cpw	x,#32
2218  02fc 2606          	jrne	L1211
2219                     ; 646         UART1->SR = (uint8_t)~(UART1_SR_RXNE);
2221  02fe 35df5230      	mov	21040,#223
2223  0302 2004          	jra	L3211
2224  0304               L1211:
2225                     ; 651         UART1->CR4 &= (uint8_t)~(UART1_CR4_LBDF);
2227  0304 72195237      	bres	21047,#4
2228  0308               L3211:
2229                     ; 653 }
2232  0308 81            	ret
2314                     ; 668 ITStatus UART1_GetITStatus(UART1_IT_TypeDef UART1_IT)
2314                     ; 669 {
2315                     	switch	.text
...
2323                     ; 670     ITStatus pendingbitstatus = RESET;
2325                     ; 671     uint8_t itpos = 0;
2327                     ; 672     uint8_t itmask1 = 0;
2329                     ; 673     uint8_t itmask2 = 0;
2331                     ; 674     uint8_t enablestatus = 0;
2333                     ; 677     assert_param(IS_UART1_GET_IT_OK(UART1_IT));
2335                     ; 680     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART1_IT & (uint8_t)0x0F));
...
2351                     ; 682     itmask1 = (uint8_t)((uint8_t)UART1_IT >> (uint8_t)4);
2353  031b 7b04          	ld	a,(OFST+2,sp)
2354  031d 4e            	swap	a
2355  031e a40f          	and	a,#15
2356  0320 6b02          	ld	(OFST+0,sp),a
2358                     ; 684     itmask2 = (uint8_t)((uint8_t)1 << itmask1);
...
2445                     ; 727         if (((UART1->SR & itpos) != (uint8_t)0x00) && enablestatus)
...
2453                     ; 730             pendingbitstatus = SET;
2455  0389 a601          	ld	a,#1
2456  038b 6b02          	ld	(OFST+0,sp),a
2459  038d 2002          	jra	L5711
2460  038f               L7021:
2461                     ; 735             pendingbitstatus = RESET;
2463  038f 0f02          	clr	(OFST+0,sp)
2465  0391               L5711:
2466                     ; 740     return  pendingbitstatus;
2468  0391 7b02          	ld	a,(OFST+0,sp)
2471  0393 5b04          	addw	sp,#4
2472  0395 81            	ret
2508                     ; 768 void UART1_ClearITPendingBit(UART1_IT_TypeDef UART1_IT)
2508                     ; 769 {
2509                     	switch	.text
2510  0396               _UART1_ClearITPendingBit:
2514                     ; 770     assert_param(IS_UART1_CLEAR_IT_OK(UART1_IT));
2516                     ; 773     if (UART1_IT == UART1_IT_RXNE)
2518  0396 a30255        	cpw	x,#597
2519  0399 2606          	jrne	L1321
2520                     ; 775         UART1->SR = (uint8_t)~(UART1_SR_RXNE);
2522  039b 35df5230      	mov	21040,#223
2524  039f 2004          	jra	L3321
2525  03a1               L1321:
2526                     ; 780         UART1->CR4 &= (uint8_t)~(UART1_CR4_LBDF);
